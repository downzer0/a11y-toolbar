...
insert_a11y_toolbar += '<li class="a11y-item"><button class="a11y-control a11y-fontsize" aria-pressed="false"><span class="a11y-icon icon-fontsize" aria-hidden="true"></span><span class="sr-only">Toggle larger font size</span></button></li>';
insert_a11y_toolbar += '<li class="a11y-item"><button class="a11y-control a11y-contrast" aria-pressed="false"><span class="a11y-icon icon-contrast" aria-hidden="true"></span><span class="sr-only">Toggle high contrast mode</span></button></li>';
insert_a11y_toolbar += '<li class="a11y-item"><button class="a11y-control a11y-saturation" aria-pressed="false"><span class="a11y-icon icon-saturation" aria-hidden="true"></span><span class="sr-only">Toggle grayscale</span></button></li>';
